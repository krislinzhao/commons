package com.hikvision.commons.cache.stats;

import com.hikvision.commons.cache.core.Cache;
import com.hikvision.commons.cache.core.LayeringCache;
import com.hikvision.commons.cache.manager.AbstractCacheManager;
...
public class StatsService {
    ...
    public void syncCacheStats() {
        ...
        executor.scheduleWithFixedDelay(() -> {
            ...
            logger.info("Layering Cache 统计信息：{}", JsonUtil.toStr(cacheStatsInfos));
            try {
                // 上报缓存统计信息
