package com.hikvision.commons.cache.aspectj;

import com.hikvision.commons.cache.redis.serializer.SerializationException;
import com.hikvision.commons.cache.util.ToStringUtils;
import cn.hutool.core.lang.Assert;
import com.hikvision.commons.cache.aspectj.annotation.*;
import com.hikvision.commons.cache.aspectj.expression.CacheOperationExpressionEvaluator;
import com.hikvision.commons.cache.core.Cache;
import com.hikvision.commons.cache.manager.CacheManager;
import com.hikvision.commons.cache.setting.FirstCacheSetting;
import com.hikvision.commons.cache.setting.LayeringCacheSetting;
import com.hikvision.commons.cache.setting.SecondaryCacheSetting;
import com.hikvision.commons.cache.support.KeyGenerator;
import com.hikvision.commons.cache.support.SimpleKeyGenerator;
...
public class LayeringAspect {
    ...
    @Pointcut("@annotation(com.hikvision.commons.cache.aspectj.annotation.Cacheable)")
    public void cacheablePointcut() {
    }

    @Pointcut("@annotation(com.hikvision.commons.cache.aspectj.annotation.CacheEvict)")
    public void cacheEvictPointcut() {
    }

    @Pointcut("@annotation(com.hikvision.commons.cache.aspectj.annotation.CachePut)")
    ...
    private void executeEvict(CacheEvict cacheEvict, Method method, Object[] args, Object target) {
        ...
        org.springframework.util.Assert.notEmpty(cacheEvict.cacheNames(), CACHE_NAME_ERROR_MESSAGE);
        // 判断是否删除所有缓存数据
