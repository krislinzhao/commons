package com.hikvision.commons.cache.listener;

import com.hikvision.commons.cache.support.LayeringCacheRedisLock;
import com.hikvision.commons.cache.util.BeanFactory;
...
public class RedisMessageService {
    ...
    public void pullMessage() {
        ...
        for (String message : messages) {
            ...
            RedisPubSubMessage redisPubSubMessage = JsonUtil.toObj(message, RedisPubSubMessage.class);
            // 根据缓存名称获取多级缓存，可能有多个
