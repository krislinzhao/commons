package com.hikvision.commons.cache.redis.serializer;
...
public class JacksonRedisSerializer extends AbstractRedisSerializer {
    ...
    public <T> byte[] serialize(T value) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException(String.format("JacksonRedisSerializer 序列化异常: %s, 【%s】", e.getMessage(), JsonUtil.toStr(value)), e);
        }
    }
    ...
    public <T> T deserialize(byte[] bytes, Class<T> resultType) throws SerializationException {
        ...
        try {
            ...
            throw new SerializationException(String.format("JacksonRedisSerializer 反序列化异常: %s, 【%s】", e.getMessage(), JsonUtil.toStr(bytes)), e);
        }
